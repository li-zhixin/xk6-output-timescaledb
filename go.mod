module github.com/li-zhixin/xk6-output-timescaledb
...
require (
	...
	github.com/grafana/xk6-browser v1.7.0 // indirect
	github.com/grafana/xk6-dashboard v0.7.5 // indirect
	github.com/grafana/xk6-output-opentelemetry v0.1.1 // indirect
	github.com/grafana/xk6-output-prometheus-remote v0.4.0 // indirect
	github.com/grafana/xk6-redis v0.3.0 // indirect
	github.com/grafana/xk6-webcrypto v0.4.0 // indirect
	github.com/grafana/xk6-websockets v0.6.0 // indirect
	...
	golang.org/x/crypto/x509roots/fallback v0.0.0-20240709155400-d66d9c31b4ae // indirect
